package com.epam.training_web_driver.student_Vitali_Semenov.Bring_It_On.HomePage;
...
public class WebDriverPastebinHomePage {
    ...
    @FindBy(xpath = "//div[@class='form-group field-postform-format']//span[@role='presentation']")
    ...
    private WebElement nameNewPasteTitleOnInfoBar;

    @FindBy(xpath = "//ol[@class='bash']")
    private WebElement bashField;

    @FindBy(xpath = "//a[text()='Bash']")
    private WebElement typeOfSyntaxOnBashField;
    ...
    public WebDriverPastebinHomePage pressSelectorSyntaxHighlighting(){
        (selectorSyntaxHighlighting).click();
        return this;
    }

    public WebDriverPastebinHomePage pressPasteSyntaxHighlightingBash(){
        (pasteSyntaxHighlightingBash).click();
        return this;
    }

    public String getTextInTheBashField(){
        return (bashField).getText();
    }

    public String getSyntaxTypeOfTheCodInTheBashField(){
        return (typeOfSyntaxOnBashField).getText();
    }
